            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <Badge variant={STATUS_COLORS[application.status] ?? "secondary"} className="text-sm px-3 py-1">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-muted-foreground text-xs uppercase tracking-wide mb-1">Employer</p>
                    <p className="font-medium">{application.program.employer.name}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="font-medium">{application.program.field}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground text-xs uppercase tracking-wide mb-1">Job Role</p>
                    <p className="font-medium">{application.program.jobRole}</p>
                  </div>
                  <div>
                    <p className="text-muted-foreground text-xs uppercase tracking-wide mb-1">Training Duration</p>
                  ...
                  {hasPendingPayment ? (
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          A fee of{" "}
                          <strong>GHS {application.program.applicationFee.toLocaleString()}</strong>{" "}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium">GHS {completedPayment.amount.toLocaleString()} paid</p>
                          {completedPayment.paidAt && (
                            <p className="text-xs text-muted-foreground">{formatDate(completedPayment.paidAt)}</p>
                          )}
                        </div>
                      </div>
                    ...
                    return (
                      <div key={step} className="flex gap-3">
                        <div className="flex flex-col items-center">
                          ...
                          {!isLast && (
                            <div
                              className={`w-0.5 h-6 mt-1 ${isPast ? "bg-success-500/40" : "bg-border"}`}
                            />
                          )}
                        </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <p className="text-sm font-medium mt-0.5">{formatDate(application.createdAt)}</p>
                </div>
                {application.submittedAt && (
                  <div>
                    <p className="text-xs text-muted-foreground uppercase tracking-wide">Submitted</p>
                    <p className="text-sm font-medium mt-0.5">{formatDate(application.submittedAt)}</p>
                  </div>
                )}
                <div>
